...
public class PersonDao extends AbstractDao<Person, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Age = new Property(1, int.class, "age", false, "MyAge");
        public final static Property Name = new Property(2, String.class, "name", false, "NAME");
        public final static Property Hid = new Property(3, Long.class, "hid", false, "HID");
    }
    ...
    public Person readEntity(Cursor cursor, int offset) {
        Person entity = new Person( //
            ...
            cursor.isNull(offset + 3) ? null : cursor.getLong(offset + 3) // hid
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Person entity, int offset) {
        ...
        entity.setHid(cursor.isNull(offset + 3) ? null : cursor.getLong(offset + 3));
     }
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" LEFT JOIN HEAD T0 ON T.\"HID\"=T0.\"_id\"");
            builder.append(' ');
